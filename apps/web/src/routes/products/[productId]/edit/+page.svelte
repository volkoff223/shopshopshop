...
<div class="flex flex-col w-full h-full p-2">
    <div class="w-full">
        <form method="POST" action="?/updateProduct" class="flex flex-col space-y-2 w-full items-center" enctype="multipart/form-data">
            ...
            <div class="form-control w-full max-w-lg">
                <label for="description" class="label font-medium pb-1">
                    ...
                    <textarea name="description" class="textarea textarea-bordered h-24 resize-none" value={data.description ?? ''} />
            </div>
            <div class="form-control w-full max-w-lg">
                ...
                <label for="thumbnail" class="avatar w-20 hover:cursor-pointer">
                    ...
                    <div class="w-20 rounded">
                        <img src={data.thumbnail ? getImageURL(data.collectionId, data.id, data.thumbnail, '80x80') : 'Error thing'} alt="Thumbnail" />
                    </div>
                </label>
                {/if}
