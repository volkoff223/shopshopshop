    ...
    <div class="w-full">
        <form action="?/create" method="POST" class="flex flex-col space-y-2 w-full items-center" enctype="multipart/form-data">
            ...
            <div class="form-control w-full max-w-lg">
                ...
                <input multiple type="file" name="images" id="images" class="file-input file-input-bordered w-full max-w-lg" />
                <div class="w-full max-w-lg pt-3">
                    <button type="submit" class="btn btnprimary w-full max-w-lg">Create Product</button>
                </div>
            </div>
        </form>
    </div>
